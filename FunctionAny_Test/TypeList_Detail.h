...
namespace t_list
{
	...
	namespace detail
	{
		...
		template <template <typename> class Predicate,
			typename First, typename Second,
			typename... Ts>
			struct filter<Predicate, First, Second, Ts...>
		{
			using helper_t = typename filter<Predicate, Ts...>::type;
		public:
			using type = typename helper_t::
		...
		template <template <typename> class Predicate,
			typename First, typename Second, typename Third,
			typename... Ts>
			struct filter<Predicate, First, Second, Third, Ts...>
		{
			using helper_t = typename filter<Predicate, Ts...>::type;
		public:
			using type = typename helper_t::
		...
		template <template <typename> class Predicate,
			typename First, typename Second, typename Third, typename Fourth,
			typename... Ts>
			struct filter<Predicate, First, Second, Third, Fourth, Ts...>
		{
			using helper_t = typename filter<Predicate, Ts...>::type;
		public:
			using type = typename helper_t::
		...
		template <template <typename> class Predicate,
			typename First, typename Second, typename Third, typename Fourth, typename Fifth,
			typename... Ts>
			struct filter<Predicate, First, Second, Third, Fourth, Fifth, Ts...>
		{
			using helper_t = typename filter<Predicate, Ts...>::type;
		public:
			using type = typename helper_t::
		...
		{
			using type = TListAddTo<TListAddToTs...>;
		};
		template <template <typename...> class TList, template <typename...> class TListAddTo, typename First, typename... TListAddToTs>
		...
		class type_list_unique<TList<First, Second, TLTs...>, TListAddTo<TListAddToTs...>>
		{
			...
			using type_helper = typename One::template append_unique<Second>;
		public:
			...
			TListAddTo<TListAddToTs...>>
		{
			...
			using type_helper = typename One::
				template append_unique<Second>::
				template append_unique<Third>;
		public:
			using type = typename type_list_unique<TList<TLTs...>, type_helper>::type;
		};
		template <template <typename...> class TList, template <typename...> class TListAddTo,
										 ...
										 TListAddTo<TListAddToTs...>>
		{
			...
			using type_helper = typename One::
				...
				template append_unique<Fourth>::
				template append_unique<Fifth>::
				template append_unique<Sixth>::
				template append_unique<Seventh>::
				template append_unique<Eighth>::
				template append_unique<Nineth>::
				template append_unique<Tenth>;
		public:
			using type = typename type_list_unique<TList<TLTs...>, type_helper>::type;
		};
